...
| 2026-04-08 | andrewtavis | Replied on [Issue 590](https://app.element.io/#/room/#ScribeAndroid:matrix.org): andrewtavisIdeally you two can take a look at #590 first as Lance has done some research there already. We don't have the emojis in for the full : to emoji display yet, but you two could work on it and we'll finalize the next release of Scribe-Data in the meantime 😊.|
